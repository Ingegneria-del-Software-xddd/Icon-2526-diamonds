"""
PROLOG_FILE = "facts_and_rules.pl"
CATEGORICAL_CSV = "dataset/diamonds_categorical.csv"
PREPROCESSED_CSV = "dataset/diamonds_preprocessed.csv"
MODEL_PATH = "test_output/model_path.joblib"
TARGET_COL = 'price'
SORTED_COLS = ['carat','cut','color','clarity','depth','table','x','y','z','price']
MINIKB_PATH = "test_output/rules.json"
EXKB_PATH = "test_output/composite_rules.json"
RANDOM_DIAMOND = "test_output/random_diamond.json"
RANDOM_STATE = 42
CV_SPLITS = 5
"""
...
# Get the directory where config.py is located (KB folder)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
ROOT_DIR = os.path.dirname(BASE_DIR)

# Paths relative to KB folder
